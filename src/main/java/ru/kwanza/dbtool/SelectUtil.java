...
class SelectUtil {
    ...
    public static <T> List<T> selectList(JdbcOperations template, String selectSQL,
    ...
    public static <T> Set<T> selectSet(JdbcOperations template, String selectSQL,
                                       RowMapper<T> rowMapper, Object... inValues) {
    ...
    public static <K, V> Map<K, List<V>> selectMapList(JdbcOperations template, String selectSQL,
                                                       RowMapper<KeyValue<K, V>> rowMapper,
                                                       Object... params) {
    ...
    public static <K0, K, V> Map<K0, Map<K, V>> selectMapOfMaps(JdbcOperations template, String selectSQL,
                                                                RowMapper<KeyValue<K0, KeyValue<K, V>>> rowMapper,
                                                                Object... params) {
    ...
    public static <K, V> Map<K, V> selectMap(JdbcOperations template, String selectSQL,
                                             RowMapper<KeyValue<K, V>> rowMapper,
                                             Object... params) {
    ...
    private static void batchSelect(JdbcOperations template, String selectSQL,
