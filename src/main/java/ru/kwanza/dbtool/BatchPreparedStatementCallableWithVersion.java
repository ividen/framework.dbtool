...
class BatchPreparedStatementCallableWithVersion<T, K, V> implements PreparedStatementCallback, PreparedStatementCreator {
    ...
    public BatchPreparedStatementCallableWithVersion(String sql, final Collection<T> objects,
                                                     UpdateSetterWithVersion<T, V> setter,
                                                     FieldHelper.Field<T, K> keyField,
                                                     FieldHelper.VersionField<T, V> versionField,
