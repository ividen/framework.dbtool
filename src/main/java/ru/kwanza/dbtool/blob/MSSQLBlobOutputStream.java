...
class MSSQLBlobOutputStream extends BlobOutputStream {
    ...
    public MSSQLBlobOutputStream(final DBTool dbTool, String tableName, String fieldName, Collection<KeyValue<String, Object>> keyValues)
        ...
        try {
            ...
            if (count != 1) {
                throw new RecordNotFoundException("Record with " + whereCondition + " not updated [" + count + "]");
            }
    ...
    private void writeNextBlock() throws IOException, RecordNotFoundException {
    ...
    private void checkUpdate() throws IOException, RecordNotFoundException {
