...
import ru.kwanza.dbtool.UpdateUtil;
...
import static ru.kwanza.dbtool.UpdateUtil.getSortedList;
...
public class UnitTestUpdateUtil extends TestCase {
    ...
    public void testObjectByKeyComparator() throws Exception {
        UpdateUtil.ObjectByKeyComparator<TestObject, Integer> comparator = new UpdateUtil.ObjectByKeyComparator<TestObject, Integer>(TestObject.KEY);
