...
public class TestUpdateException extends TestCase {
    ...
    public void testUpdateException() {
        List<TestEntity> list = Arrays.asList(new TestEntity(1, "Value 1"),
                new TestEntity(2, "Value 2"), new TestEntity(3, "Value 3"));
        List<TestEntity> list2 = Arrays.asList(new TestEntity(4, "Value 4"),
                new TestEntity(5, "Value 5"));
