...
import ru.kwanza.dbtool.blob.NullBlobInputStream;
...
public abstract class TestBlobInputStream extends DBTestCase {
    ...
    protected IDataSet getDataSet() throws Exception {
        IDataSet tmpExpDataSet = new FlatXmlDataSetBuilder().build(this.getClass().getResourceAsStream("./data/blob_input_stream_test.xml"));
