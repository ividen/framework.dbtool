...
public abstract class TestUpdateUtil extends AbstractTestUpdateUtil {
    ...
    public void testInsertSuccess() throws Throwable {
        ...
        try {
            ...
            try {
                assertEquals(10,
                        getDBTool().update("insert into test_table(xkey,name,version) values(?,?,?)", testEntities, TEST_BATCHER_3));
    ...
    public void testUpdateConstrained_ByNulableConstrained() throws Throwable {
        ...
        try {
            ...
            try {
                assertEquals(9, getDBTool().update("update test_table set version=?, name=?, xkey=? where xkey=?", testEntities,
