...
public class EntityMappingHelper {
    ...
    public static FetchMapping createFetchMapping(AnnotatedElement annotatedElement, EntityField entityField) {
        final String propertyName = getPropertyName(annotatedElement);
        return new FetchMapping(propertyName, entityField, createEntityField(annotatedElement));
    }
